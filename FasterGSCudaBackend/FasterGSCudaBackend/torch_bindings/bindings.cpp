...
namespace cubemapencoder_api = faster_gs::cubemapencoder;

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward", &rasterization_api::forward_wrapper);
    m.def("backward", &rasterization_api::backward_wrapper);
    m.def("forward_dr", &rasterization_api::forward_wrapper_dr);
    m.def("backward_dr", &rasterization_api::backward_wrapper_dr);
    ...
    m.def("cubemap_encode_forward", &cubemapencoder_api::cubemap_encode_forward, "cubemap encode forward (CUDA)");
    m.def("cubemap_encode_backward", &cubemapencoder_api::cubemap_encode_backward, "cubemap encode backward (CUDA)");
}
